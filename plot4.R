...
#plot data
par(mar = c(4,4,0.5,1))
plot(x = household_power_200702$dateTime, y = household_power_200702$Global_active_power, xlab = "", ylab = "Global Active power", type = "l")
plot(x = household_power_200702$dateTime, y = household_power_200702$Voltage, xlab = "datetime", ylab = "Voltage", type = "l")
...
legend("topright", col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty = c(1,1), lwd = c(1,1), cex = 0.5, bty = "n")
